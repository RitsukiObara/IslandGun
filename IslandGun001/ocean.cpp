...
namespace
{
	...
	const int OCEAN_DIVI_WIDTH = 50;		// 海の縦の分割数
	const int OCEAN_DIVI_DEPTH = 50;		// 海の奥行の分割数
	const float OCEAN_WIDTH = 10000.0f;		// 海の幅
	const float OCEAN_DEPTH = 10000.0f;		// 海の奥行
	const float OCEAN_WAVE_HEIGHT = 20.0f;	// 海の高さ
