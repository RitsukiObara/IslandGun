...
// 静的メンバ変数宣言
//--------------------------------------------
CBulletManager* CBulletManager::m_pManager = nullptr;			// プレイヤーの変数
...
// 登録処理
//============================
void CBulletManager::Regist(CBullet* pThis)
{
	if (m_pTop == nullptr)
	{ // オブジェクトが NULL の場合
	...
	{ // 上記以外
		...
		// ローカルポインタを宣言
		CBullet* pObject = m_pTop;			// 先頭のオブジェクト
...
{
	// ローカル変数宣言
	CBullet* pObj = nullptr;		// 現在のオブジェクトのポインタ
...
// オブジェクトの取得処理
//===========================================
CBullet* CBulletManager::GetTop(void)
{
	// オブジェクトの情報を渡す
	return m_pTop;
}
...
// リスト構造の引き抜き処理
//===========================================
void CBulletManager::Pull(CBullet* pThis)
{
	// ローカル変数宣言
	CBullet* pObj = nullptr;		// 現在のオブジェクトのポインタ
...
// 取得処理
//============================
CBulletManager* CBulletManager::Get(void)
{
	// マネージャーのポインタを返す
	return m_pManager;
}